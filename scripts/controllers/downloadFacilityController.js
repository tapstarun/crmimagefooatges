(function () {
	...
	angular
        .module('imageCrmApp')
        .controller('DownloadFacilityCtrl', DownloadFacilityCtrl);

    DownloadFacilityCtrl.$inject = ['CommonService','$rootScope','apiUrl','$scope','dateFormat'];

    function DownloadFacilityCtrl(CommonService,$rootScope,apiUrl,$scope,dateFormat) {
