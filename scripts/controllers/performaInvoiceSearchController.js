(function () {
	...
	angular
        .module('imageCrmApp')
        .controller('PerformaInvoiceSearchCtrl', PerformaInvoiceSearchCtrl);

    PerformaInvoiceSearchCtrl.$inject = ['CommonService','$rootScope','apiUrl','$scope','dateFormat'];

    function PerformaInvoiceSearchCtrl(CommonService,$rootScope,apiUrl,$scope,dateFormat) {
