(function () {
	...
	angular
        .module('imageCrmApp')
        .controller('LowRemaningCreditListCtrl', LowRemaningCreditListCtrl);

    LowRemaningCreditListCtrl.$inject = ['CommonService','$rootScope','apiUrl','$scope','dateFormat'];

    function LowRemaningCreditListCtrl(CommonService,$rootScope,apiUrl,$scope,dateFormat) {
